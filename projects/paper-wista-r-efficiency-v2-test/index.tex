...
\newcommand{\metadatapage}{%
  ...
  \begin{tabular}{@{}lrrrrrrr@{}}
    \toprule
    \textbf{Abschnitt} & \textbf{Wörter} & \textbf{Zeichen} & \textbf{Tab.} & \textbf{Abb.} & \textbf{Fußn.} & \textbf{Quellen} & \textbf{Vorgabe} \\
    \midrule
    Insgesamt & \textcolor{wistaBlue}{\textbf{\totalwords}} & \textcolor{wistaBlue}{\textbf{\totalchars}} & \textcolor{wistaBlue}{\textbf{\total{table}}} & \textcolor{wistaBlue}{\textbf{\total{figure}}} & \textcolor{wistaBlue}{\textbf{\footnotecountnum}} & \textcolor{wistaBlue}{\textbf{\citationcountnum}} & 30\,000 Z. \\
  ...
  % Keywords count
  {\large\bfseries\color{wistaDarkGray} Schlüsselwörter \& Keywords}\\[0.3cm]
  
  \begin{tabular}{@{}lr@{}}
    \toprule
    \textbf{Typ} & \textbf{Anzahl} \\
    \midrule
    Schlüsselwörter & \textcolor{wistaBlue}{\textbf{\schlusselwortercount}} \\
    Keywords & \textcolor{wistaBlue}{\textbf{\keywordscount}} \\
    \bottomrule
  \end{tabular}
...
\setstretch{1}
\renewcommand{\totalchars}{11 260}
\renewcommand{\totalwords}{1 235}
...
\newcommand{\sectionrows}{            Einleitung (inkl. Unterabschnitte) & \textcolor{wistaBlue}{\textbf{1 231}} & \textcolor{wistaBlue}{\textbf{11 260}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
}
\ifdraftmode
\metadatapage
\fi
