...
\setstretch{1}
\renewcommand{\totalchars}{37 179}
\renewcommand{\totalwords}{4 512}
...
\renewcommand{\citationcountnum}{22}
...
\newcommand{\sectionrows}{            Einleitung & \textcolor{wistaBlue}{\textbf{1 231}} & \textcolor{wistaBlue}{\textbf{3 448}} & \textcolor{wistaBlue}{\textbf{3}} & \textcolor{wistaBlue}{\textbf{7}} & --- \\
            ...
            Ergebnis für das vollständige BTP & \textcolor{wistaBlue}{\textbf{84}} & \textcolor{wistaBlue}{\textbf{676}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
...
durchgeführt werden können (s. \textbf{?@sec-ergebns}).
...
(Kristiansen, 2023 - Link:
https://www.destatis.de/DE/Methoden/WISTA-Wirtschaft-und-Statistik/2023/04/business-tax-panel-042023.html).
...
erste Version des BTP (2013 - 2019) besteht aus knapp 67 Millionen
Beobachtungen. Mit der Aktualisierung um das Berichtsjahr 2020 wird sich
die Zahl der Beobachtungen auf uca. 78 Millionen erhöhen. Auch der
Merkmalsumfang von zurzeit über 2.700 Merkmalen wird durch Erweiterung
von Berichtsjahren steigen. Bereits aktuell und insbesondere durch die
anstehende Aktualisierung steht der Fachbereich sowie das FDZ vor der
...
(FDZ, 2024 --\textgreater{} IN QUELLEN aufnehmen!) verwendet.
