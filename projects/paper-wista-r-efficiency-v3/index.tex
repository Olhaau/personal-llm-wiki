...
\setstretch{1}
\renewcommand{\totalchars}{39 287}
\renewcommand{\totalwords}{4 758}
...
\newcommand{\sectionrows}{            Einleitung & \textcolor{wistaBlue}{\textbf{1 231}} & \textcolor{wistaBlue}{\textbf{12 723}} & \textcolor{wistaBlue}{\textbf{5}} & \textcolor{wistaBlue}{\textbf{7}} & --- \\
            Anwendungsfall Business-Tax-Panel & \textcolor{wistaBlue}{\textbf{125}} & \textcolor{wistaBlue}{\textbf{1 291}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
            Techniche Infrastruktur & \textcolor{wistaBlue}{\textbf{145}} & \textcolor{wistaBlue}{\textbf{1 498}} & \textcolor{wistaBlue}{\textbf{1}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
            Datenverarbeitungsmethoden & \textcolor{wistaBlue}{\textbf{810}} & \textcolor{wistaBlue}{\textbf{8 372}} & \textcolor{wistaBlue}{\textbf{3}} & \textcolor{wistaBlue}{\textbf{5}} & --- \\
            Performanzvergleich & \textcolor{wistaBlue}{\textbf{999}} & \textcolor{wistaBlue}{\textbf{10 325}} & \textcolor{wistaBlue}{\textbf{4}} & \textcolor{wistaBlue}{\textbf{6}} & --- \\
            Ergebnis für das vollständige BTP & \textcolor{wistaBlue}{\textbf{84}} & \textcolor{wistaBlue}{\textbf{868}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
            Fazit & \textcolor{wistaBlue}{\textbf{407}} & \textcolor{wistaBlue}{\textbf{4 206}} & \textcolor{wistaBlue}{\textbf{1}} & \textcolor{wistaBlue}{\textbf{2}} & --- \\
}
...
\textbf{\href{https://parquet.apache.org/}{Parquet}} bildet die
technische Grundlage für effiziente Datenverarbeitung:

\begin{itemize}
\tightlist
\item
  \textbf{Speicherformat}: Spaltenbasiertes Format, das effizient lesbar
  und schreibbar ist
\item
  \textbf{Komprimierung}: Standardmäßig komprimiert, was Speicherplatz
  spart
\item
  \textbf{Partitionierung}: Ermöglicht aufgeteilte Speicherung für
  selektiven Datenzugriff
\item
  \textbf{Kompatibilität}: Wird bereits standardmäßig im FDSZ angeboten
\end{itemize}

Für hohe performante Verarbeitung von Datenmengen überhalb des RAMs
betrachten wir die folgenden Werkzeuge, die in Form von
\textbf{R-Paketen} verfügbar sind:
...
\item
  ...
  eine Python-orientierte Syntax als auch eine dplyr-kompatible Variante
  (tidypolars), die für R-Nutzende vertrauter ist. Polars nutzt moderne
  Optimierungstechniken und ist für sehr große Datensätze ausgelegt. Die
  Rust-Implementierung sorgt für hohe Geschwindigkeit bei gleichzeitig
  sparsamer Nutzung der Systemressourcen.
\end{itemize}
