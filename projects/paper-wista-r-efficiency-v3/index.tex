...
\setstretch{1}
\renewcommand{\totalchars}{36 998}
\renewcommand{\totalwords}{4 496}
...
\emph{Business-Tax-Panel} (BTP) zur Verfügung (s.
Kapitel~\ref{sec-btp}). Es verknüpft verschiedene
Unternehmenssteuerstatistiken und bietet mit fast 3 000 Merkmalen und 67
Millionen Beobachtungen ein erhebliches Analysepotenzial, stellt
gleichzeitig jedoch hohe technische Anforderungen an die Analysesysteme.
...
(s. Kapitel~\ref{sec-infrastruktur}). Für die Statistikproduktion konnte
...
Nutzerfreundlichkeit zu erweitern (s. Kapitel~\ref{sec-methoden}).
Dieser Artikel wird potenzielle R-Pakete für den Einsatz im
Statistischen Bundesamt und FDZ bewerten (s.
Kapitel~\ref{sec-benchmark}) und anhand des BTP demonstrieren, wie
relevante Auswertungen nachvollziehbar innerhalb von wenigen Sekunden
durchgeführt werden können (s. Kapitel~\ref{sec-ergebnis}).
...
Passend zu den Anforderungen aus Kapitel~\ref{sec-infra-anf} ist
darunter ein breites Spektrum an Datenverabeitungsmethoden, von
hochperformanten Werkzeugen bis hin zu Verbesserungen der
Nutzererfahrung. Da R frei verfügbar ist, wird es an Universitäten weit
verbreitet eingesetzt, und es stehen zahlreiche Schulungsmaterialien zur
Verfügung. Viele Mitarbeitende des Statistischen Bundesamts und
...
Arbeitstagen). Die zum Zeitpunkt des in Kapitel~\ref{sec-benchmark}
...
Anwendungsfälle aus Kapitel~\ref{sec-btp} im folgenden
Kapitel~\ref{sec-benchmark} durchgeführt.
