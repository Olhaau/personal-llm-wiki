...
\setstretch{1}
\renewcommand{\totalchars}{34 450}
\renewcommand{\totalwords}{4 255}
...
\renewcommand{\citationcountnum}{13}
...
\newcommand{\sectionrows}{            Einleitung & \textcolor{wistaBlue}{\textbf{1 231}} & \textcolor{wistaBlue}{\textbf{11 157}} & \textcolor{wistaBlue}{\textbf{3}} & \textcolor{wistaBlue}{\textbf{4}} & --- \\
            Anwendungsfall Business-Tax-Panel & \textcolor{wistaBlue}{\textbf{125}} & \textcolor{wistaBlue}{\textbf{1 132}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Techniche Infrastruktur & \textcolor{wistaBlue}{\textbf{145}} & \textcolor{wistaBlue}{\textbf{1 314}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Datenverarbeitungsmethoden & \textcolor{wistaBlue}{\textbf{810}} & \textcolor{wistaBlue}{\textbf{7 341}} & \textcolor{wistaBlue}{\textbf{2}} & \textcolor{wistaBlue}{\textbf{3}} & --- \\
            Performanzvergleich & \textcolor{wistaBlue}{\textbf{999}} & \textcolor{wistaBlue}{\textbf{9 054}} & \textcolor{wistaBlue}{\textbf{3}} & \textcolor{wistaBlue}{\textbf{3}} & --- \\
            Ergebnis für das vollständige BTP & \textcolor{wistaBlue}{\textbf{84}} & \textcolor{wistaBlue}{\textbf{761}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Fazit & \textcolor{wistaBlue}{\textbf{407}} & \textcolor{wistaBlue}{\textbf{3 688}} & \textcolor{wistaBlue}{\textbf{1}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
}
...
Datenmengen geführt, sondern auch neue Möglichkeiten für die
statistische Analyse eröffnet. Gleichzeitig sind die Erwartungen der
Öffentlichkeit an Aktualität und Detailliertheit der Statistiken
gestiegen. Um diese Herausforderungen zu bewälten, evaluiert der
vorliegende Artikel die Effizienz verschiedener
Datenverabeitungsmethoden mit dem Ziel Handlungsempfehlungen für die
Praxis abzuleiten.
...
Auswertungen zur Verfügung stellt. Um diesen Herausforderungen zu
bewältigen, hat das \emph{Statstische Bundesamt} in 2025 wesentliche
Meilensteine in der Modernisierung der technischen Analyseinfrastruktur
erreicht (dargestellt in Kapitel~\ref{sec-infrastruktur}). Anfang 2025
wurden die R-Server für Auswertungen und Datenverabeitungen in der
Statistikproduktion modernisiert und stark erweitert. Seit November 2025
stehen auch dem FDZ neue R- und Stata-Analyseserver (sog. FDZ
OnSite-Server) für wissenschaftliche Auswertungen zu Verfügung.
...
somit auf nataürliche weise Einzug in die amtliche
Statistik.{[}\^{}uros{]}
...
\textbf{?@sec-benchmark}). Durch die Beantwortung können für den
...
In dem FDZ haben Forschende die Möglichkeit, eigene Analysen mit
amtlicher Mikrodaten durchführen. Der Zugangsweg ``Onsite-Nutzung''
ermöglicht den Zugriff zu formal anonymisierten Einzeldaten ermöglichen.
Forschende können selbst ein \emph{Gastwissenschaftsarbeitsplatz} (GWAP)
in den Liegenschaften des FDZ nutzen oder via \emph{kontrollierter
...
Stata ist in viele Fachgebieten der Wissenschaft sehr beliebt und
erfreut sich hoher Nachfrage im FDZ, wird anhand der User Experience
gerne genutzt. Ist auf Arbeitsspeicher angewiesen, und kommt leicht an
die kapazitären Grenzen.

(Tendenz kommerzieller Analysesoftware zu befristeten Lizenzen und
Cloudnutzung bietet der langfristig ausgelegten und stabilen amtl.
Statistik große Risiken), sodass sich ein Trend zu Open-Source
Technologien entwickelt. In der internationalen amtlichen Statistik seit
Jahren auf dem Vormarsch. Langsam steigt auch Verbreitung von insb. R in
den dt. Statistikämtern.
...
\tightlist
\item
  beschreiben, welche Datenverarbeitungen in der Statistikproduktion
  häufig durchgeführt werden und, das unsere Use Cases dazu passen.
\item
  Was muss in der Datenbereitstellung erfolgen: Erstellung von MDR
  usw\ldots{} Test auf Nutzbarkeit für wiss. Zwecke (?)
\end{itemize}
