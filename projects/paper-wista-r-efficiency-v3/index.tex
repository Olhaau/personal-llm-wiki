...
\setstretch{1}
\renewcommand{\totalchars}{37 003}
\renewcommand{\totalwords}{4 499}
...
die Anwendungsfälle aus Absatz~\ref{sec-btp} in
...
Bundesamtes und den neuen OnSite-R- und Stata-Servern des FDZ gemessen.
Weiterführende Performanzmessung sowie der vollständig reproduzierbare
Code sind auf Opencode verfügbar\footnote{www.opencode.de/URL-To-Be-Announced.}.
