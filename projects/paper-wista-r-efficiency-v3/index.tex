...
\newcommand{\metadatapage}{%
  ...
  \begin{tabular}{@{}lrrrrrr@{}}
    ...
    Autor 1 (O. Hauke) & --- & \textcolor{wistaBlue}{\textbf{\authoronechars}} & --- & --- & 350 Z. \\
    Autor 2 (A. Kristiansen) & --- & \textcolor{wistaBlue}{\textbf{\authortwochars}} & --- & --- & 350 Z. \\
    \midrule
    \sectionrows
    \bottomrule
  \end{tabular}
...
\setstretch{1}
\renewcommand{\totalchars}{40 911}
\renewcommand{\totalwords}{5 069}
...
\renewcommand{\citationcountnum}{11}
...
\newcommand{\sectionrows}{            Einleitung & \textcolor{wistaBlue}{\textbf{1 231}} & \textcolor{wistaBlue}{\textbf{13 249}} & \textcolor{wistaBlue}{\textbf{4}} & \textcolor{wistaBlue}{\textbf{4}} & --- \\
            Anwendungsfall Business-Tax-Panel & \textcolor{wistaBlue}{\textbf{125}} & \textcolor{wistaBlue}{\textbf{1 345}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Techniche Infrastruktur & \textcolor{wistaBlue}{\textbf{145}} & \textcolor{wistaBlue}{\textbf{1 560}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Datenverarbeitungsmethoden & \textcolor{wistaBlue}{\textbf{810}} & \textcolor{wistaBlue}{\textbf{8 718}} & \textcolor{wistaBlue}{\textbf{2}} & \textcolor{wistaBlue}{\textbf{2}} & --- \\
            Performanzvergleich & \textcolor{wistaBlue}{\textbf{999}} & \textcolor{wistaBlue}{\textbf{10 752}} & \textcolor{wistaBlue}{\textbf{3}} & \textcolor{wistaBlue}{\textbf{3}} & --- \\
            Ergebnis für das vollständige BTP & \textcolor{wistaBlue}{\textbf{84}} & \textcolor{wistaBlue}{\textbf{904}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Fazit & \textcolor{wistaBlue}{\textbf{407}} & \textcolor{wistaBlue}{\textbf{4 380}} & \textcolor{wistaBlue}{\textbf{1}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
}
...
wachsenden Datenmengen die steigenden Nutzerbedarfe mit qualitativ
hochwertige und zeitnahe statistische Informationen zu bedienen. Um
diese Herausforderung zu bewältigen, hat das StBA in 2025 wesentliche
Ziele in der Modernisierung seiner technischen Analyseinfrastruktur
erreicht (dargestellt in Kapitel~\ref{sec-infrastruktur}). Anfang 2025
StBA wurden die Server des StBA für die auswertung in R stark erweitert.
Seit Nov.~2025 steht dem Forschungsdatenzentrum des statistischen
Bundesamts neue Server für wissenschaftliche Auswertungen zu Verfügung.
R bietet Zugang zu modernen Datenverarbeitungsmethoden, die simpel
bedienbar sind und gleichzeitig Datenverarbeitungsbedarfe anhand großer
Datenmengen in Sekunden beantworten können (beschrieben in
Kapitel~\ref{sec-methoden}). Dadurch kann für den
...
Datenmengen zu bedienen. Es stellt sich die Frage welchen
Programmiermethoden geeignet sind, die neuen Datenverarbeitungsbedarfe
mit spezifischen neuen Infrastruktur bedient werden können (diskutiert
in \textbf{?@sec-benchmark}).

In dem \emph{Forschungsdatenzentrum des statistischen Bundesamts (hier
kurz FDZ) und dem Forschungsdatenzentrum der Statistischen Ämter der
Länder} haben Forschende die Möglichkeit, eigene Analysen mit amtlicher
Mikrodaten durchführen. Der Zugangsweg ``Onsite-Nutzung'' ermöglicht den
Zugriff zu formal anonymisierten Einzeldaten ermöglichen. Forschende
können selbst ein \emph{Gastwissenschaftsarbeitsplatz} (GWAP) in den
Liegenschaften des FDZ nutzen oder via \emph{kontrollierter
Datenfernverarbeitung} (KDFV) können entwickelte Auswertungsprogramme
durch das FDZ ausgeführt werden.Jedoch hatte die Wissenschaft in
\textcite{bmf2020dateninfrastruktur} Kritik am Datenbestand für
empirische Steuerforschung und dessen Aktualität geäußert. Darüber
hinaus wird seit Jahren die technische Datenverarbeitungsinfrastruktur
des FDZ bemängelt.

Um diese Situation zu verbessern, hat das Bundesfinanzministerium das
\emph{``Netzwerk empirischer Steuerforschung''} (NeSt) gegründet.
\footnote{https://www.bundesfinanzministerium.de/Web/DE/Themen/Steuern/Steuerliche\_Themengebiete/NeSt/netzwerk-fuer-empirische-steuerforschung.html}
Vorangetrieben durch das NeSt konnte das Statistische Bundesamt bereits
erfolgreich den Datenbestand erweitern. Seit 2023 steht das
\emph{Business-Tax-Panel} (BTP) zur Verfügung und wird bereits wieder
überarbeitet. Es veknüpft verschiedene Unternehmensstatistiken und birgt
dadurch mit fast 3 000 Merkmalen ein großes Analysepotenzial (genauer in
\textbf{?@sec-btp} beschrieben).\footnote{https://www.forschungsdatenzentrum.de/de/steuern/btp}.

Eine weitere Initiative des NeSt hat zu der Moderniserung
IT-Infrastruktur des FDZ geführt (dem sog. OnSite-Server\footnote{}).
\textbf{Dadurch bietet das FDZ seit November 2025 bietet neue Server mit
großen Systemkapazitäten für R und Stata für wissenschaftliche
Auswertungen an}. Erstmalig können die vollen Kapazitäten neben der KDFV
auch an den GWAPs genutzt werden, um große Datensätze im Vollmaterial
auszuwerten. Wir werden in den FDZ OnSite-Servern demonstrieren, dass
viele Auswertungsbedarfe das BTP im Vollmaterial mit geeigneten
Programmiermethoden innerhalb von Sekunden beantwortet werden können.
...
\begin{verbatim}
\begin{table*}
\caption{Versionen verfügbarer R-Packages}\label{tbl-pkg-versions}
