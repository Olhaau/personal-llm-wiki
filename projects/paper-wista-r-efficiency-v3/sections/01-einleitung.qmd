...
Die amtliche Statistik steht vor der Herausforderung, bei stetig wachsenden Datenmengen die steigenden Nutzerbedarfe mit qualitativ hochwertige und zeitnahe statistische Informationen zu bedienen. Um diese Herausforderung zu bedienen, hat das StBA in 2025 wesentliche Ziele in der Modernisierung seiner technischen Analyseinfrastruktur erreicht. Seit  Anfang 2025 R-Server, seit Nov. 2025 FDZ Server. Jedoch stellt sich die Frage mit welchen Methoden sich die neuen technischen Mittel voll ausgeschöpft werden kann.



Moderne Datenverarbeitungsmethoden in R sind simpel bedienbar in der Lage eine hohe Performanz erreichen, sodass im gesamten Statistikerstellungsprozesses technische Hilfsmittel bereitstellen, diese Herausforderung zu bewältigen. Anfang 2025 wurden die Server des StBA für die auswertung in R ausgebaut.

<!-- Steigende Anforderungen der Wissenschaft -->

In dem *Forschungsdatenzentrum des statistischen Bundesamts (hier kurz FDZ) und dem Forschungsdatenzentrum der Statistischen Ämter der Länder* haben Forschende die Möglichkeit, eigene Analysen mit amtlicher Mikrodaten durchführen. Der Zugangsweg "Onsite-Nutzung" ermöglicht den Zugriff zu formal anonymisierten Einzeldaten ermöglichen. Forschende können selbst ein *Gastwissenschaftsarbeitsplatz* (GWAP) in den Liegenschaften des FDZ nutzen oder via *kontrollierter Datenfernverarbeitung* (KDFV) können entwickelte Auswertungsprogramme durch das FDZ ausgeführt werden.Jedoch hatte die Wissenschaft in @bmf2020dateninfrastruktur Kritik am Datenbestand für empirische Steuerforschung und dessen Aktualität geäußert. Darüber hinaus wird seit Jahren die technische Datenverarbeitungsinfrastruktur des FDZ bemängelt. 

<!-- BTP als neues Produkt -->

Um diese Situation zu verbessern, hat das Bundesfinanzministerium das *"Netzwerk empirischer Steuerforschung"* (NeSt) gegründet. [^nest-web] Vorangetrieben durch das NeSt konnte das Statistische Bundesamt bereits erfolgreich den Datenbestand erweitern und die technische Datenbereitstellungsinfrastrukur entscheidend ausbauen. Seit 2023 steht das  *Business-Tax-Panel* (BTP) zur Verfügung und wird bereits wieder überarbeitet. Es veknüpft verschiedene Unternehmensstatistiken und birgt dadurch mit fast 3 000 Merkmalen ein großes Analysepotenzial (genauer in @sec-btp beschrieben).[^btp-web]. 

<!-- OSS -->

Eine weitere Initiative des NeSt auch zur Bereitstellung einer neuen IT-Infrastruktur geführt (dem sog. OnSite-Server[^oss]). **Seit November 2025 bietet das FDZ neue Server mit großen Systemkapazitäten für R und Stata an**. Erstmalig können die vollen Kapazitäten neben der KDFV auch an den GWAPs genutzt werden, sodass bisherige Zuschnitte / Stichproben / (Reduzierung der Datenmenge aus technischen Gründen) reduziert / vermieden werden können. Auch das BTP kann in der neuen Infrastruktur mit geeigneten Programmiermethoden im Vollmaterial ausgewertet werden. Entsprechende Methoden präsentieren wir in @sec-methoden.

<!--Technischen Erleichterungen der Nutzerverwaltung durch die FDZ, reduziert Betreuungsaufwände und damit Wartezeiten der Nutzenden in der KDFV oder an den GWAPs.-->
