...
- beschreiben, welche Datenverarbeitungen in der Statistikproduktion häufig durchgeführt werden und, das unsere Use Cases dazu passen. (s.u. entsprechend dem FDZ Bund)
...
Häufig fokussieren sich Forschungsprojekte im FDZ Bund auf die folgenden Operationen:

1. Lesen Daten ein
2. Transformieren die Statistikprodukte des FDZ Bund, verknüpfen ggf. mit eigene Daten
...
-   Besonders breit mit 3 000 Merkmalen, 69 Mio. Beobachtung, sodass zeilenbasierte Formate problematisch sind. 
...
-   Anwendungsfälle volles Spektrum
    ...
    -   Auswertung durch Wissenschaft im FDZ Bund
-->