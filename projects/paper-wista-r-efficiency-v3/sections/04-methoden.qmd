...
| **Befehl** | **Beschreibung** |
|------------|------------------|
| `read_csv("data/btp/data.csv")` | Liest CSV-Datei ein |
| `group_by(jahr)` | Gruppiert Daten nach Jahr |
| `summarize(u = sum(str_detect(verk, "u")))` | Zählt Beobachtungen mit "u" in Variable verk |
