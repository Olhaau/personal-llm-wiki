...
- [arrow](https://arrow.apache.org/docs/r/) [@R-arrow] (Erstveröffentlichung: 2019)
  - c++ basiert
  - erlaubt Parallelisierung, Datenaufteilung, Lazy-Computations, Datenformat im RAM passend zu Parquet
  - tba - s. Vortrag
- [duckdb](https://duckdb.org/docs/stable/clients/r) [@R-duckdb] (Erstveröffentlichung: 2020)
  - R-Package , in-memory DB, ...
  - tba - s. Vortrag
- [polars](https://pola-rs.github.io/r-polars/) [@R-polars] (Erstveröffentlichung: 2022)
