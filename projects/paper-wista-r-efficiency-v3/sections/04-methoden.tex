...
\setstretch{1}
\renewcommand{\totalchars}{8 589}
\renewcommand{\totalwords}{1 092}
...
\renewcommand{\citationcountnum}{10}
...
\renewcommand{\authoronechars}{0}
\renewcommand{\authortwochars}{0}
\newcommand{\sectionrows}{            Einleitung & \textcolor{wistaBlue}{\textbf{1 231}} & \textcolor{wistaBlue}{\textbf{2 781}} & \textcolor{wistaBlue}{\textbf{1}} & \textcolor{wistaBlue}{\textbf{3}} & --- \\
            Anwendungsfall Business-Tax-Panel & \textcolor{wistaBlue}{\textbf{125}} & \textcolor{wistaBlue}{\textbf{282}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Techniche Infrastruktur & \textcolor{wistaBlue}{\textbf{145}} & \textcolor{wistaBlue}{\textbf{327}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Datenverarbeitungsmethoden & \textcolor{wistaBlue}{\textbf{810}} & \textcolor{wistaBlue}{\textbf{1 830}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{2}} & --- \\
            Performanzvergleich & \textcolor{wistaBlue}{\textbf{999}} & \textcolor{wistaBlue}{\textbf{2 257}} & \textcolor{wistaBlue}{\textbf{1}} & \textcolor{wistaBlue}{\textbf{3}} & --- \\
            Ergebnis für das vollständige BTP & \textcolor{wistaBlue}{\textbf{84}} & \textcolor{wistaBlue}{\textbf{189}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{0}} & --- \\
            Fazit & \textcolor{wistaBlue}{\textbf{407}} & \textcolor{wistaBlue}{\textbf{919}} & \textcolor{wistaBlue}{\textbf{0}} & \textcolor{wistaBlue}{\textbf{1}} & --- \\
}
...
\item
  ...
  performanteste klassische DVM. An die Syntax an base-r angesiedelt und
  nur hier verwendet, spezielles Wissen notwendig.
\item
...
Datenverarbeitung, das für besonders hohe Lesbarkeit des Codes bekannt
ist. Dazu dient eine eigenen Programmiersyntax, sog.
...
dies die Packages \{dtplyr\} \autocite{R-dtplyr} oder \{tidytable\}
\autocite{R-tidytable} um Wie im Falle von \{dtplyr\} kann die
Übersetzung zu \{dplyr\} jedoch die Performanz
