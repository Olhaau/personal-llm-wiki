...
```{r}
#| label: tbl-variables
#| tbl-cap: "Betrachtete Variablen des BTP"
#| echo: false
...
knitr::kable(variables_table, 
             col.names = c("Variable", "Statistik", "Beschreibung"),
             booktabs = FALSE,
             format = "latex",
             escape = FALSE) %>%
  kable_styling(
  ...
  column_spec(2:3, background = "#f0f8ff") %>%
...
btp_stats <- data.frame(
  ...
  Wert = c("2013-2019 (jaehrliche Erweiterung)", ">66 Millionen", ">2.700", 
           "Vollerhebung", "Sekundaererhebung (Finanzverwaltung)")
)

btp_stats$Wert <- c("2013-2019 (jährliche Erweiterung)", ">66 Millionen", ">2.700", 
...
knitr::kable(btp_stats, 
  ...
  row_spec(0, background = "#dce6f0", color = "#404040", bold = TRUE) %>%
  column_spec(1, border_left = TRUE, border_right = TRUE, color = "black", background = "white") %>%
  column_spec(2, background = "#f0f8ff")
```
