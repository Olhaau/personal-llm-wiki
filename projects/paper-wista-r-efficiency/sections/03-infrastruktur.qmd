...
Für Stata oder R in KDFV oder GWAP

- bis zu 512 GB RAM pro Nutzung
- bis zu 16 Kerne á X MHZ ...
- schnelle Verbindung zu Netzwerkspeicher
...
your project directory and highlights the fact that small changes in your code can result in large
performance gains.
This also shows that common tasks can usually be accomplished much faster using R than using
Stata. However, we also pointed out that you should not only focus on computing time alone as
shorter computing times might be offset by longer programming time
