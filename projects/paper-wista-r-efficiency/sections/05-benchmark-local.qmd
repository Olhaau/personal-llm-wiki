...
Unerwarteterweise ist die Laufzeit von {polars} für diese Datenmenge mit 1,2 Minuten weit abgeschlagen, obwohl {polars} mit dem gleichenapfel123 Auswertungsskript für kleinere Datenmengen immer die geringste Laufzeit aufwies. Da {polars} das jüngste der betrachteten R-Packages ist, vermuten wir Stabilitätsprobleme in der vorliegenden Version 1.0.1[^4].
...
Insgesamt kommen wir zu dem Ergebnis, dass {arrow} kombiniert mit {parquet} aus den folgenden Gründen die beste Datenverarbeitungsmethode für die Bewältigung unserer Aufgaben ist:

1.  

die geringste Laufzeit für unsere Zwecke benötigt und ebenso die Entwicklungszeit minimiert hat. Somit bietet {arrow} im Gesamtpaket die beste Datenverarbeitungsmethode für die Bewältigung unserer Aufgaben.
