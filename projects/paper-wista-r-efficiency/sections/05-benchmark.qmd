...
Klassische Methoden kommen bei der betrachteten Datenmenge bereits ihrer Grenze nahe. Falls {data.table} genauso angewendet wird, wie für kleine Datenmengen, beansprucht in unserem Anwemdungsfall die verfügbaren 512 GB Arbeitsspeicher vollständig. Klassische Methoden müssen also viel geschickter die relevanten Variablen manuell selektieren unter Beachtung der eigenen Arbeitsspeicherverbrauchs.
...
1. Für die relevant größte Datenmenge ist {arrow} am schnellsten. 
2. auch die Nutzererfahrung und die damit einhergehenden Entwicklungaufwände waren in {arrow} am geringsten.
  1. tidy syntax nativ
3. {arrow} spart ausreichend Arbeitsspeicher (Verbrauch unter 1 GB) (tba: Fußnote zu duckdb/polars). Der Arbeitsspeicherverbrauch von {arrow} ist in unserer Auswertung nahezu konstant abhängig von der Datenmenge, sodass {arrow} leicht auf noch größere Datenmengen skalieren kann
