...
- Unsere Empfehlung: {arrow} + {parquet} (bei Bedarf + {duckdb})

### Auswirkung auf IT-Infrastruktur

- Fokus auf Hardware und Software mit größtem Optimierungspotenzial
- Fokus auf R, Parquet und hier genannte Packages
- Langfristig kann die Verbreitung geeigneter Software die Hardwareanforderungen reduzieren
...
- Vorbild für andere FDZ (?)
- Optimierung von Hardware und Software Angebot

### Auswirkungen auf die Statistikproduktion

- Nutzung für die Überarbeitung des BTP
- Mindeststeuer (?)
- Perspektivisch andere große Datensätze: DRG, TPP
...
- Dazu ist R als frei verfügbare Open-Source Software leicht zu lernen und {arrow} bietet hoch-performante Analysen selbst für R-Basiskenntnisse.
