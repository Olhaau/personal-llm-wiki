---
title: "Partitioning - Unstructured"
token: "5005"
source_link: "https://docs.unstructured.io/open-source/core-functionality/partitioning"
topic: "pdf-llm-ingestion"
tags: ["source/web", "privacy/public", "ingest", "pdf", "llm", "extraction"]
generated_at: "2026-05-19T06:25:44Z"
source: "web"
---
[Skip to main content](https://docs.unstructured.io/open-source/core-functionality/partitioning#content-area)

[Unstructured home page![light logo](https://mintcdn.com/unstructured-53/0PpGBVwVpmOG7-W9/logo/light.png?fit=max&auto=format&n=0PpGBVwVpmOG7-W9&q=85&s=2d8941dad21a694eaba2ec7456ea8eb6)![dark logo](https://mintcdn.com/unstructured-53/0PpGBVwVpmOG7-W9/logo/dark.png?fit=max&auto=format&n=0PpGBVwVpmOG7-W9&q=85&s=080894a38c4f019066ddffd1b285b6db)](https://docs.unstructured.io/)

Search...

⌘KAsk AI

- [Try Unstructured for free](https://unstructured.io/?modal=try-for-free)
- [Try Unstructured for free](https://unstructured.io/?modal=try-for-free)
...
[Welcome](https://docs.unstructured.io/welcome)[Concepts](https://docs.unstructured.io/concepts/overview)[UI](https://docs.unstructured.io/ui/overview)[API](https://docs.unstructured.io/api-reference/overview)[Example code](https://docs.unstructured.io/examplecode/notebooks)[Business](https://docs.unstructured.io/business/overview)[Open source](https://docs.unstructured.io/open-source/introduction/overview)[Support](https://docs.unstructured.io/support/request)[FAQ](https://docs.unstructured.io/faq/faq)

- [Account support (e-mail)](mailto:support@unstructured.io)
- [Open source support (Slack)](https://short.unstructured.io/pzw05l7)
- [Service status](https://unstructuredio.trust.pagerduty.com/posts/dashboard)
- [Feedback](https://docs.google.com/forms/d/e/1FAIpQLSciKwrJD4m_9ObcTveWMb9yK63FWd7gLxIknovc3kLw_0qUrg/viewform?usp=sf_link)
- [Blog](https://unstructured.io/blog)
- [Product info](https://unstructured.io/)
- [Trust portal](https://trust.unstructured.io/)
- [Contact Sales (e-mail)](mailto:sales@unstructured.io)
...
- [Overview](https://docs.unstructured.io/open-source/introduction/overview)
- [Supported file types](https://docs.unstructured.io/open-source/introduction/supported-file-types)

##### Getting started with open source

- [Quickstart](https://docs.unstructured.io/open-source/introduction/quick-start)
- Installation

##### Using Unstructured open source

- [Overview](https://docs.unstructured.io/open-source/core-functionality/overview)
...
- [Extracting](https://docs.unstructured.io/open-source/core-functionality/extracting)
- [Staging](https://docs.unstructured.io/open-source/core-functionality/staging)
- [Chunking](https://docs.unstructured.io/open-source/core-functionality/chunking)
- [Embedding](https://docs.unstructured.io/open-source/core-functionality/embedding)

##### Ingestion

- [Overview](https://docs.unstructured.io/open-source/ingestion/overview)
- [Supported file types](https://docs.unstructured.io/open-source/ingestion/supported-file-types)
- [Ingest CLI](https://docs.unstructured.io/open-source/ingestion/ingest-cli)
- [Ingest Python library](https://docs.unstructured.io/open-source/ingestion/python-ingest)
- [Ingest dependencies](https://docs.unstructured.io/open-source/ingestion/ingest-dependencies)
...
- [Examples](https://docs.unstructured.io/open-source/how-to/examples)
- [Speed up processing of large files and batches](https://docs.unstructured.io/open-source/how-to/speed-up-large-files-batches)
- [Get element contents](https://docs.unstructured.io/open-source/how-to/get-elements)
- [Process a subset of files](https://docs.unstructured.io/open-source/how-to/filter-files)
- [Set embedding behavior](https://docs.unstructured.io/open-source/how-to/embedding)
- [Extract tables as HTML](https://docs.unstructured.io/open-source/how-to/text-as-html)
- [Extract images and tables from documents](https://docs.unstructured.io/open-source/how-to/extract-image-block-types)
- [Get chunked elements](https://docs.unstructured.io/open-source/how-to/get-chunked-elements)
- [Set the OCR agent](https://docs.unstructured.io/open-source/how-to/set-ocr-agent)

##### Best practices

- [Chunking](https://unstructured.io/blog/chunking-for-rag-best-practices)
- [Embedding](https://unstructured.io/blog/understanding-embedding-models-make-an-informed-choice-for-your-rag)

##### Concepts

- [Document elements and metadata](https://docs.unstructured.io/open-source/concepts/document-elements)
- [Models](https://docs.unstructured.io/open-source/concepts/models)
- [Partitioning strategies](https://docs.unstructured.io/open-source/concepts/partitioning-strategies)

##### Integrations

- [Overview](https://docs.unstructured.io/open-source/integrations)

On this page

- [partition](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition)
- [partition\_csv](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_csv)
- [partition\_doc](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_doc)
- [partition\_docx](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_docx)
- [partition\_email](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_email)
- [partition\_epub](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_epub)
- [partition\_html](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_html)
- [partition\_image](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_image)
- [partition\_md](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_md)
- [partition\_msg](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_msg)
- [partition\_multiple\_via\_api](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_multiple_via_api)
- [partition\_odt](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_odt)
- [partition\_org](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_org)
- [partition\_pdf](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_pdf)
- [partition\_ppt](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_ppt)
- [partition\_pptx](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_pptx)
- [partition\_rst](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_rst)
- [partition\_rtf](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_rtf)
- [partition\_text](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_text)
- [partition\_tsv](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_tsv)
- [partition\_via\_api](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_via_api)
- [partition\_xlsx](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_xlsx)
- [partition\_xml](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_xml)
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition) `partition`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_csv) `partition_csv`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_doc) `partition_doc`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_docx) `partition_docx`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_email) `partition_email`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_epub) `partition_epub`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_html) `partition_html`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_image) `partition_image`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_md) `partition_md`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_msg) `partition_msg`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_multiple_via_api) `partition_multiple_via_api`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_odt) `partition_odt`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_org) `partition_org`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_pdf) `partition_pdf`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_ppt) `partition_ppt`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_pptx) `partition_pptx`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_rst) `partition_rst`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_rtf) `partition_rtf`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_text) `partition_text`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_tsv) `partition_tsv`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_via_api) `partition_via_api`
...
If you are using the legacy [Unstructured Partition Endpoint](https://docs.unstructured.io/api-reference/legacy-api/partition/overview), you can use the `api_url` kwarg to point the `partition_via_api` function at your Unstructured Partition URL.
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_xlsx) `partition_xlsx`
...
## [​](https://docs.unstructured.io/open-source/core-functionality/partitioning#partition_xml) `partition_xml`
...
[Overview](https://docs.unstructured.io/open-source/core-functionality/overview)[Cleaning](https://docs.unstructured.io/open-source/core-functionality/cleaning)

⌘I

[website](https://unstructured.io/)[youtube](https://www.youtube.com/@UnstructuredIO)[slack](https://short.unstructured.io/pzw05l7)[x](https://x.com/UnstructuredIO)[twitter](https://twitter.com/UnstructuredIO)[linkedin](https://www.linkedin.com/company/unstructuredio)[reddit](https://www.reddit.com/r/UnstructuredIO)[github](https://github.com/Unstructured-IO)[instagram](https://www.instagram.com/unstructuredio)

[Powered byThis documentation is built and hosted on Mintlify, a developer documentation platform](https://www.mintlify.com?utm_campaign=poweredBy&utm_medium=referral&utm_source=unstructured-53)

Assistant

Responses are generated using AI and may contain mistakes.

[Contact support](mailto:support@unstructured.io)
